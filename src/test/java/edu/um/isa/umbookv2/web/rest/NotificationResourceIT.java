...
class NotificationResourceIT {
    ...
    private static final String DEFAULT_CONTENDIO = "AAAAAAAAAA";
    private static final String UPDATED_CONTENDIO = "BBBBBBBBBB";
    ...
    public static Notification createEntity(EntityManager em) {
        Notification notification = new Notification().contendio(DEFAULT_CONTENDIO);
        return notification;
    }
    ...
    public static Notification createUpdatedEntity(EntityManager em) {
        Notification notification = new Notification().contendio(UPDATED_CONTENDIO);
        return notification;
    }
    ...
    void createNotification() throws Exception {
        ...
        assertThat(testNotification.getContendio()).isEqualTo(DEFAULT_CONTENDIO);
    }
    ...
    void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.[*].contendio").value(hasItem(DEFAULT_CONTENDIO)));
    }
    ...
    void getNotification() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.contendio").value(DEFAULT_CONTENDIO));
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.contendio(UPDATED_CONTENDIO);
        ...
        Notification testNotification = notificationList.get(notificationList.size() - 1);
        assertThat(testNotification.getContendio()).isEqualTo(UPDATED_CONTENDIO);
    }
    ...
    void fullUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.contendio(UPDATED_CONTENDIO);
